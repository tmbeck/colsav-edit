...
Example road building: used the save game editor to build a road at tile 44, 44.

Hex compare reported the following difference:

```
Change at 0x439F: 0x01 -> 0x09  Unknown Map C (0x0A24 Position (44),(44))
```
